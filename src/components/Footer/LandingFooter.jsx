const LandingFooter2 = () => {
    return(
        <footer className="flex flex-col w-full h-[500px] mt-12">
            ...
            <div className="h-[800px] bg-[#2E7D32] p-4 flex text-[#e8e8e8]flex-col md:flex-row ">
                <div className="flex-1 text-white p-2 text-[12px]">
                    ...
                    <p className="text-sm">Email: barakalaushi@gmail.com</p>
                </div>
                <div className="flex-1 text-white p-1 text-[12px]">
                    <h4 className="font-bold text-xl">About</h4>
                    <p className="text-sm leading-4">Bauchi state is one of the 36 states in Nigeria. It is blessed with many resources, people and culture and boost of diverse value which it offers to the country and the world at large. BConnect is here to connect you with the right vendors and services you need</p>
                </div>
            </div>
        </footer>
    )
