            ...
            <main className='min-h-screen'>
                <header className="h-screen p-4 md:h-[644px] w-full bg-header_image bg-cover m-0 top-0 flex justify-between py-8 items-center flex-col">
                    ...
                    <div className='flex-1 flex flex-col justify-center p-4 gap-8 items-center'>
                        ...
                        <p className='text-[#F2F2F2] text-[16px] md:text-[24px] font-normal text-center w-[80vw]'>Bauchi Connect Puts Bauchi’s Best at Your Fingertips. Your Story of Connection Begins Now! </p>
                        ...
                        <div className="flex w-[90vw] md:w-auto flex-col md:flex-row gap-4">
                            ...
                            <button className="bg-[#EF6C00] h-[2rem] md:h-auto text-white rounded pl-4 pr-4 text-[16px] font-semibold">Search</button>
                        </div>
                        ...
                        <div className="flex gap-4 md:gap-8">
                            <div className='w-[96px] h-[98px] flex flex-col items-center justify-start'>
                                ...
                                <p className='text-[#808080] text-[14px] md:text-[16px] font-semibold'>Top Vendors</p>
                            </div>
                            ...
                            <div className='w-[96px] h-[150px] flex flex-col items-center justify-start'>
                                ...
                                <p className='text-[#808080] text-[14px] md:text-[16px] text-center font-semibold'>CAC <br /> Verified <br />Vendors</p>
                            </div>
                            ...
                            <div className='w-[96px] h-[150px] flex flex-col items-center justify-start'>
                                ...
                                <p className='text-[#808080] text-[14px] md:text-[16px] text-center font-semibold'>Vendors <br /> near <br />you</p>
                            </div>
