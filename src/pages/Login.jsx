      ...
      <div className="w-full flex flex-col gap-2 md:gap-6 items-center justify-center min-h-screen">
        <div>
          ...
          <p className="font-regular text-[16px] text-center">
            Stay connected with your favourite vendors - sign in now.
          </p>
        </div>
        ...
        <button
          ...
          type="submit"
          onClick={handleLogin}
          className="border bg-[#993420]  text-white text-center py-4 w-full flex gap-2 justify-center items-center overflow-hidden"
        >
          <span>Login</span>{" "}
          {isLoading && (
            <span>
              <SpinningCircles fontSize={14} scale={0.5} color="#660033" />
            </span>
          )}
        </button>
      </div>
