    ...
    <>
        ...
        <div className="relative p-8 px-2 md:px-[136px] flex flex-col md:flex-row gap-4">
          ...
          <div className="flex-[4] ">
            <div className="text[12px] font-regular leading-[14.52px] text-[#808080]">
              {user.lang == "ha" ? `Kategori - ` : `Category - `}
              {category}
            </div>

            <div className="fw-[600] text-[#464B4F] text-[24px] md:text-[48px] leading-[58.09px] flex gap-4 align-end">
              {item.name}
            ...
            <div className="text-[24px] text-[#808080] flex gap-1 items-center">
              <img className="size-[24px]" src="/vendors-location.svg" />{" "}
            ...
            <GrayContainer>
              <WhiteInGrayContainer>
                <div>
                  ...
                  {user.lang == "ha" ? (
                    <p className="text-[#808080] text-[14px] leading-[20px]">
                      {item?.description_ha}
                    </p>
                  ) : (
                    <p className="text-[#808080] text-[14px] leading-[20px]">
              ...
              <WhiteInGrayContainer>
                <h5>{user.lang == "ha" ? `Lokacin bude` : `Opening time`}</h5>
              ...
              <WhiteInGrayContainer>
                <p className="text-[#808080] text-[14px] leading-[20px]">
                  JMarket Directory/ Find A Vendor section is NOT an endorsement
                  of any of the vendors listed. It is simply for
                  informationational purposes. JMarket and its affiliates will
                  not be liable for any losses, injuries or damages that may
                  arise in the relationship between an individual, group or
                  organization and any of the vendors listed.
                </p>
              </WhiteInGrayContainer>
            </GrayContainer>
          </div>
      ...
      {showModal && (
        <PaymentModal
          ...
          service_id={item.id}
          handleModal={handleProcessOrder}
        />
      )}
    </>
  );
