      ...
      <div className="w-full flex flex-col gap-2 md:gap-6 items-center justify-center min-h-screen">
        <div>
          ...
          <p className="font-regular text-[16px] text-center">
            Create your account now and get in touch with your customers - sign
            in now.
          </p>
        </div>
        <div className="w-[100%] flex flex-col gap-2 bg-[#e8e8e899] p-4 justify-center items-center">
          ...
          <fieldset>
            ...
            <label htmlFor="tc">I accept JMarket's terms and conditions</label>
          </fieldset>
        </div>

        <button
          onClick={handleRegister}
          className="border bg-[#993420]  text-white text-center py-2 w-full"
        >
          {"Register"}
        </button>
