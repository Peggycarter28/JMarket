...
const EcommercePage = () => {
  ...
  const slides = [
    {
      imgSrc: "/landing-page/slider-1.png",
      altText: "carousel 1",
      label:
        user.lang === "en"
          ? "Explore great services in Plateau"
          : "Ku zo ku ga abubuwa dabam dabam daga jihar Plateau",
    },
    {
      imgSrc: "/landing-page/market.jpg",
      altText: "carousel 2",
      label:
        user.lang === "en" ? "Discover more vendors" : "Samu ƙarin yan kasuwa",
    },
    {
      imgSrc: "/landing-page/unnamed (1).jpg",
      altText: "carousel 3",
      label:
        user.lang === "en"
          ? "Exclusive deals in your area"
          : "Kasuwanci na musamman a yankinku",
    },
  ];
      ...
      <div className="w-full">
              ...
              {slides.map((_, index) => (
                <span
                  ...
                  className={`h-3 w-3 rounded-full ${
                    index === currentSlide ? "bg-slate-100" : "bg-slate-400"
                  }`}
        ...
        <div className="grid md:grid-cols-6 gap-4 mt-4 md:mx-[100px] cursor-pointer">
          {[
            {
              name: "Buy Now",
              src: "/landing-page/masa2.jpg",
              link: "/search/category/5",
            },
            {
              name: "New Vendors",
              src: "/landing-page/new-arrival.png",
              link: "/search/category/2",
            },
            {
              name: "Shop Local",
              src: "/landing-page/market.jpg",
              link: "/search/category/1",
            },
            {
              name: "Electronics",
              src: "/landing-page/ds.jpg",
              link: "/search/category/3",
            },
            {
              name: "Top Vendors",
              src: "/landing-page/unnamed (1).jpg",
              link: "/search/category/6",
            },
            {
              name: "Special Offers",
              src: "/landing-page/lcmrk.jpg",
              link: "/search/category/7",
            },
          ].map((item, index) => (
            <Link
              key={index}
              to={item.link}
              className="relative h-56 hover:bg-slate-300 duration-300"
            >
              <img
                src={item.src}
                alt={item.name}
